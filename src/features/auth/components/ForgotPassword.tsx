...
export const ForgotPassword = () => {
    ...
    const formik = useFormik({
        ...
        onSubmit: values => {
            dispatch(createNewPassword({email: values.email, message: `<div style="background-color: lime; padding: 15px">password recovery link: <a href='https://alertdsg.github.io/Cards/#/set-new-password/$token$'>link</a></div>`, from: "test-front-admin <alertdsg@gmail.com>",}))
            formik.resetForm()
        },
    })
                        ...
                        <FormControl>
                            <form onSubmit={formik.handleSubmit}>
                                <FormGroup style={{paddingBottom: '20px'}}>
                                    ...
                                    <p style={{paddingTop: '20px', opacity: '.7'}}>Enter your email address ad we will send you further
                                        instructions</p>
